...
// ✅ Что сделано:
// Убрали innerHTML, чтобы задать свойства изображения напрямую.
...
// onerror, который ставит заглушку, если изображение заблокировано.

// Теперь изображения максимально защищены от блокировки, а заглушка подставляется, если загрузка не удалась.
